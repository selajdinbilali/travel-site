...
/***/ function(module, exports, __webpack_require__) {
	...
	var StickyHeader = function () {
		function StickyHeader() {
			...
			this.lazyImages = (0, _jquery2.default)(".lazyload"); // selectionne les lazyload pour regle les pbs avec waypoints
			this.siteHeader = (0, _jquery2.default)(".site-header");
		...
		_createClass(StickyHeader, [{
			...
			value: function createHeaderWaypoint() {
				var that = this;
				new Waypoint({
					element: this.headerTriggerElement[0], // [0] accéder au premier le dom au lieu de l'objet jquery
					handler: function handler(direction) {
						// ajoute au dessus et en dessous comportement
						if (direction == "down") {
	...
	var Modal = function () {
				...
				_createClass(Modal, [{
							...
							value: function keyPressHandler(e) {
										if (e.keyCode == 27) {
													this.closeModal(); // this n'est pas this qu'on pense sans le bind
										}
							}
				}, {
							key: "openModal",
							value: function openModal() {
										...
										return false; // à cause du # quie remonte en haut dans le bouton get-in-touch
							}
				}, {
							key: "closeModal",
